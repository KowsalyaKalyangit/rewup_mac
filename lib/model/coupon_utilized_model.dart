...
CouponUtilizedModel couponUtilizedModelFromJson(String str) =>
    CouponUtilizedModel.fromJson(json.decode(str));

String couponUtilizedModelToJson(CouponUtilizedModel data) =>
...
class CouponUtilizedModel {
  ...
  factory CouponUtilizedModel.fromJson(Map<String, dynamic> json) =>
      CouponUtilizedModel(
